...
export class AuthApi {
     ...
     */
    public async confirmForgotPassword (confirmForgotPasswordRequestDto: ConfirmForgotPasswordRequestDto, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LoginResponseDto;  }> {
        const localVarPath = this.basePath + '/auth/users/confirm-forgot-password';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(confirmForgotPasswordRequestDto, "ConfirmForgotPasswordRequestDto")
        };
     ...
     */
    public async forgotPassword (forgotPasswordRequestDto: ForgotPasswordRequestDto, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/auth/users/forgot-password';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(forgotPasswordRequestDto, "ForgotPasswordRequestDto")
        };
